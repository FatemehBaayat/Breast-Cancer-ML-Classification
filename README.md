...
| File                                         | Description                                                                                        |
| -------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| `breast-cancer-wisconsin-ml-project.ipynb`   | Main Jupyter notebook containing the full code, EDA, modelling, evaluation, and outputs            |
...
3. **Exploratory Data Analysis**
   Missing values, class balance, feature ranges, feature distributions, and feature correlations were analyzed.
...
7. **Pipeline-Based Preprocessing**
...
The final model produced **2 false negatives** for the malignant class, meaning that **2 malignant samples were incorrectly predicted as benign**. This is clinically important because false negatives may correspond to missed cancer cases.
